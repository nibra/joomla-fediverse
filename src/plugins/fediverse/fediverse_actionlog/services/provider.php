...
use NX\Plugin\Fediverse\FediverseActionlog\Extension\FediverseActionlog;
    ...
    public function register(Container $container): void
    {
        ...
        $container->set(
            ...
            static function(Container $container) {
                $pluginConfig = (array) PluginHelper::getPlugin('fediverse', 'fediverse_actionlog');

                $plugin = new FediverseActionlog(
